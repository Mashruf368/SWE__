...
public class Student {
    ...
    public void enrollIn(Course c) {
        if (c == null) return;
        if (!Mediator.getInstance().isVisibleToStudents(c)) {
        ...
        Mediator.getInstance().enroll(this, c);
    ...
    public void waitlistFor(Course c) {
        ...
        Mediator.getInstance().addtowaitlist(c, this);
    }

    public void dropCourse(Course c) {
        if (c == null) return;
        Mediator.getInstance().dropStudentSide(c, this);
    }
